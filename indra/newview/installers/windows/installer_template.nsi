...
Icon          %%SOURCE%%\installers\windows\install_icon_Astra.ico
UninstallIcon %%SOURCE%%\installers\windows\install_icon_Astra.ico
...
InstallDirRegKey HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\${INSTNAME}" ""
...
Function CheckIfAlreadyCurrent
  Push $0
	ReadRegStr $0 HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\$INSTPROG" "Version"
...
;RMDir /r "$WINDIR\Application Data\AstraViewer64\cache"
;
;FunctionEnd
...
Push $2
  ...
  LOOP:
    ...
    StrCmp $INSTFLAGS "" RM_ALL RM_CACHE
      RM_ALL:
        RMDir /r "$2\Application Data\AstraViewer64"
      RM_CACHE:
        # Local Settings directory is the cache, there is no "cache" subdir
        RMDir /r "$2\Local Settings\Application Data\AstraViewer64"
        # Vista version of the same
        RMDir /r "$2\AppData\Local\AstraViewer64"
        Delete "$2\Application Data\AstraViewer64\user_settings\settings_windlight.xml"
...
Push $0
  ReadRegStr $0 HKEY_LOCAL_MACHINE "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Shell Folders" "Common AppData"
  StrCmp $0 "" +2
  RMDir /r "$0\AstraViewer64"
Pop $0

; Delete filse in C:\Windows\Application Data\SecondLife
; If the user is running on a pre-NT system, Application Data lives here instead of
; in Documents and Settings.
RMDir /r "$WINDIR\Application Data\AstraViewer64"
...
DetailPrint "Removing AstraViewer64 password"

SetShellVarContext current
Delete "$APPDATA\AstraViewer64\user_settings\password.dat"
...
DeleteRegKey HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\$INSTPROG"
...
lbl_check_silent:
	...
	ReadRegStr $0 HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\${INSTNAME}" "InstallerLanguage"
...
lbl_build_menu:
	...
	WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\${INSTNAME}" "InstallerLanguage" $LANGUAGE
lbl_return:
    Pop $0
    Return
FunctionEnd
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Write registry
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\$INSTPROG" "" "$INSTDIR"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\$INSTPROG" "Version" "${VERSION_LONG}"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\$INSTPROG" "Flags" "$INSTFLAGS"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\$INSTPROG" "Shortcut" "$INSTSHORTCUT"
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\AstraViewer64.\$INSTPROG" "Exe" "$INSTEXE"
