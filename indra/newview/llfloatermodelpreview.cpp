...
//	childSetCommitCallback("upload_textures", boost::bind(&LLFloaterModelPreview::toggleCalculateButton, this), NULL);
	...
	childSetCommitCallback("lod_file_or_limit", instancerefresh, this);
...
void LLFloaterModelPreview::loadModel_continued(AIFilePicker* filepicker, S32 lod)
{
	...
	mModelPreview->loadModel(filepath, 3);
}
...
{
	if(!sInstance)
		new LLFloaterModelPreview("LLFloaterModelPreview");
...
//static
void LLFloaterModelPreview::instancerefresh(LLUICtrl* ctrl, void* user_data)
{
